...
public final class BlockRenderMap {
    ...
    public BlockRenderMap() {
        ...
        putAllFaces(Blocks.FLOWER_CORNFLOWER, "flower_cornflower");
        putAllFaces(Blocks.FLOWER_HOUSTONIA, "flower_houstonia");
        putAllFaces(Blocks.FLOWER_OXEYE_DAISY, "flower_oxeye_daisy");
        putAllFaces(Blocks.FLOWER_RED_DOUBLE, "flower_red_double");
        putAllFaces(Blocks.VINE, "vine");
